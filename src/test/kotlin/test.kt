...
//rnbqkbnr/p1pppppp/8/6N1/1pP5/8/PP1PPPPP/RNBQKB1R b KQkq c3 0 1
//rnbqkbnr/p1pppppp/8/6N1/8/2p5/PP1PPPPP/RNBQKB1R w KQkq - 0 1
class test {
    ...
    val enPassantBlackStart = "rnbqkbnr/p1pppppp/8/6N1/1pP5/8/PP1PPPPP/RNBQKB1R b KQkq c3 0 1"
    val enPassantBlackEnd =  "rnbqkbnr/p1pppppp/8/6N1/8/2p5/PP1PPPPP/RNBQKB1R w KQkq - 0 1"

    val enPassantWhiteStart = "r1bqkbnr/ppp1pppp/n7/3pP3/8/8/PPPP1PPP/RNBQKBNR w KQkq d6 0 1"
    val enPassantWhiteEnd = "r1bqkbnr/ppp1pppp/n2P4/8/8/8/PPPP1PPP/RNBQKBNR b KQkq - 0 1"

    @Test
    fun enPassantWhite() {
        //setup
        val board = BoardData(enPassantWhiteStart)

        board.boardLogic.move(board.getPiece(3,4), Pair(2,3))

        assert(enPassantWhiteEnd == board.toString())
    }
    ...
    fun enPassantBlack() {
        //setup
        val board = BoardData(enPassantBlackStart)

        board.boardLogic.move(board.getPiece(4,1), Pair(5,2))

        assert(enPassantBlackEnd == board.toString())
    }
